...
export const EVENT_TYPES_GUIDE: EventTypeGuide[] = [
  ...
  },
  {
    ...
    description: 'Sprawdzona oferta menu, elegancka dekoracja stołów, bezpieczna przestrzeń i miła atmosfera rodzinna.',
    recommendedVenueId: 'both',
...
export const VENUES: Venue[] = [
  {
    ...
    weddingAllowed: true,
    description: 'Główny lokal bankietowy mieszczący do 90 osób przy ul. Konstytucji 3 Maja 3. Nowoczesna, przestronna sala idealna na wesela, komunie, chrzciny, 18-stki oraz bankiety. Do dyspozycji gości oddajemy taras wypoczynkowy, grill oraz duży bezpłatny parking bezpośrednio przed lokalem.',
    features: [
